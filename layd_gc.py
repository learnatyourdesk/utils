...
def _extract_repos(repo_name):
    ...
    while not eof_page:
        ...
        git_url = 'https://github.com/'+repo_name+'?page='+str(page_counter)+'&tab=repositories'
...
def usage():
    ...
    print('  python zu_gc01.py -l <git user name without quite>')
    print('  For example to list all repositories under learnatyourdesk')
    print('  python zu_gc01.py -l learnatyourdesk')
    print('')
    print('To clone all repositories')
    print('  python zu_gc01.py -l <git user name without quite> -c')
    print('  For example to clone all repositories under learnatyourdesk')
    print('  python zu_gc01.py -l learnatyourdesk -c')
    print('')
    print('Note: Repositories will be cloned under same directory where command is execuyed')
